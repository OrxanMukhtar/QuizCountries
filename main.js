...
const makeQuestion = () => {
  ...
  if (twoRandom == 0) {
    ...
    flagOrCapital.innerHTML = randomCountry.capital + " haranin paytaxtidir?";
  } else {
    flagOrCapital.innerHTML = "Sekildeki hansi olkenin bayraqidir?";
  }
...
function resultPage() {
    ...
    resultImg.src = "./img/cup.jpg";
  
    let resultText = document.createElement("p");
    resultText.innerHTML =`Sizin ${score} duzgun cavabiniz var`;
  
  
    let tryAgainBtn = document.createElement("button");
    tryAgainBtn.classList.add("try-again-btn");
    tryAgainBtn.innerHTML = "Yeniden basla";
